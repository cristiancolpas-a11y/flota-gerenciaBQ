...
// 22 Specific checklist items for Routine 1
const CHECKLIST_ITEMS = [
  // 5. CAMBIO
  { id: 'r1_c_aceite_motor', name: 'Aceite Motor ( Para los Inter MV607 se realiza cada 16 mil KM)', category: 'CAMBIO', sectionNum: 5, sectionTitle: '5. ¿A los siguientes componentes se les realizó CAMBIO?' },
  { id: 'r1_c_filtro_aceite', name: 'Filtro de aceite ( Para los Inter MV607 se realiza cada 16 mil KM)', category: 'CAMBIO', sectionNum: 5, sectionTitle: '5. ¿A los siguientes componentes se les realizó CAMBIO?' },
  { id: 'r1_c_filtro_primario', name: 'Filtro combustible primario ( Para los Inter MV607 se realiza cada 16 mil KM)', category: 'CAMBIO', sectionNum: 5, sectionTitle: '5. ¿A los siguientes componentes se les realizó CAMBIO?' },
  { id: 'r1_c_filtro_secundario', name: 'Filtro combustible secundario o trampa de agua', category: 'CAMBIO', sectionNum: 5, sectionTitle: '5. ¿A los siguientes componentes se les realizó CAMBIO?' },

  // 6. ENGRASE
  { id: 'r1_e_suspension', name: 'General Suspensión', category: 'ENGRASE', sectionNum: 6, sectionTitle: '6. ¿A los siguientes componentes se les realizó ENGRASE?' },
  { id: 'r1_e_articulaciones', name: 'Articulaciones, Crucetas, Cardanes, Bujes y Pasadores', category: 'ENGRASE', sectionNum: 6, sectionTitle: '6. ¿A los siguientes componentes se les realizó ENGRASE?' },

  // 7. LIQUIDOS
  { id: 'r1_l_agua_bateria', name: 'Agua Batería', category: 'LIQUIDOS', sectionNum: 7, sectionTitle: '7. ¿A los siguientes componentes se les completó LIQUIDOS?' },
  { id: 'r1_l_refrigerante', name: 'Liquido Refrigerante y LimpiaParabrisas', category: 'LIQUIDOS', sectionNum: 7, sectionTitle: '7. ¿A los siguientes componentes se les completó LIQUIDOS?' },
  { id: 'r1_l_aceites_direccion', name: 'Aceites de dirección, Caja y Diferencial', category: 'LIQUIDOS', sectionNum: 7, sectionTitle: '7. ¿A los siguientes componentes se les completó LIQUIDOS?' },

  // 8. TENSION
  { id: 'r1_t_frenos', name: 'Frenos', category: 'TENSION', sectionNum: 8, sectionTitle: '8. ¿A los siguientes componentes se les realizó TENSIÓN?' },
  { id: 'r1_t_correas', name: 'Correas Motor', category: 'TENSION', sectionNum: 8, sectionTitle: '8. ¿A los siguientes componentes se les realizó TENSIÓN?' },
  { id: 'r1_t_embrague', name: 'Embrague y/o calibrar varillaje (según parámetros)', category: 'TENSION', sectionNum: 8, sectionTitle: '8. ¿A los siguientes componentes se les realizó TENSIÓN?' },

  // 9. INSPECCION
  { id: 'r1_i_filtro_aire', name: 'Filtro de aire primario y secundario', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r1_i_luces', name: 'Luces Delanteras, Traseras', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r1_i_luces_tablero', name: 'Luces e Indicadores de Tablero', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r1_i_mangueras_ref', name: 'Tuberías y Mangueras Refrigeración y la Concentración de refrigerante', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r1_i_mangueras_aceite', name: 'Tuberías y Mangueras Aceite', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r1_i_admision_escape', name: 'Sistema Admisión and Escape (Conductos y Turbo)', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r1_i_terminales_rotulas', name: 'Terminales y Rotulas', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r1_i_fugas', name: 'Fugas de aire y aceites', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r1_i_suspension', name: 'Suspensión en General', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r1_i_marcha_minima', name: 'Marcha Mínima motor', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r1_i_presion_llantas', name: 'Presión y labrado llantas', category: 'INSPECCION', sectionNum: 9, sectionTitle: '9. ¿A los siguientes componentes se les INSPECCIONÓ?' }
];

// Helper to get dynamic checklist items for Routine 1 based on mileage frequency
export const getChecklistItemsByFrequency = (freq: string) => {
  if (!freq) return [];
  if (freq === '5.000 km') {
    // 5. Cambio (all 4)
    // 6. Engrase (all 2)
    // 7. Liquidos (Agua batería, Refrigerante)
    return CHECKLIST_ITEMS.filter(item => 
      item.id === 'r1_c_aceite_motor' ||
      item.id === 'r1_c_filtro_aceite' ||
      item.id === 'r1_c_filtro_primario' ||
      item.id === 'r1_c_filtro_secundario' ||
      item.id === 'r1_e_suspension' ||
      item.id === 'r1_e_articulaciones' ||
      item.id === 'r1_l_agua_bateria' ||
      item.id === 'r1_l_refrigerante'
    );
  }
  if (freq === '8.000 km') {
    // 5. Cambio (all 4)
    // 6. Engrase (all 2)
    // 7. Liquidos (all 3)
    // 8. Tension (Frenos, Correas Motor)
    return CHECKLIST_ITEMS.filter(item => 
      item.id === 'r1_c_aceite_motor' ||
      item.id === 'r1_c_filtro_aceite' ||
      item.id === 'r1_c_filtro_primario' ||
      ...
      item.id === 'r1_l_agua_bateria' ||
      item.id === 'r1_l_refrigerante' ||
      item.id === 'r1_l_aceites_direccion' ||
      item.id === 'r1_t_frenos' ||
      item.id === 'r1_t_correas'
    );
  }
  if (freq === '10.000 km') {
    // 5. Cambio (all 4)
    ...
    // 7. Liquidos (all 3)
    // 8. Tension (all 3)
    // 9. Inspección (Filtro de aire, Luces, Luces tablero, Fugas, Presión llantas)
    return CHECKLIST_ITEMS.filter(item => 
      item.id === 'r1_c_aceite_motor' ||
      item.id === 'r1_c_filtro_aceite' ||
      item.id === 'r1_c_filtro_primario' ||
      ...
      item.id === 'r1_t_frenos' ||
      item.id === 'r1_t_correas' ||
      item.id === 'r1_t_embrague' ||
      item.id === 'r1_i_filtro_aire' ||
      item.id === 'r1_i_luces' ||
      item.id === 'r1_i_luces_tablero' ||
      item.id === 'r1_i_fugas' ||
      item.id === 'r1_i_presion_llantas'
    );
  }
  // '20.000 km' (All items)
...
export const RoutineForm_1: React.FC<RoutineForm1Props> = ({
  vehicles,
  drivers,
  onSuccess,
  onBack
  ...
  const handlePhotoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (updatedPhotos.length > 0) {
      const collage = await createMosaic(updatedPhotos, `EVIDENCIA RUTINA 1 - ${plate || 'N/A'}`);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newExecution: RoutineExecution = {
      ...
      templateId: 'rutina_1',
      templateName: 'RUTINA 1: Lubricación, Filtros y Refrigeración',
    ...
    <div className="bg-slate-50 min-h-screen p-4 md:p-8 space-y-8 rounded-[2.5rem] border border-slate-200/60 shadow-inner">
      ...
      <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-in fade-in duration-200">
        <div className="space-y-1">
          ...
          <h3 className="text-2xl font-black text-slate-900 uppercase tracking-tight flex items-center gap-3">
            <ClipboardCheck className="text-emerald-500" size={28} /> Llenado de Rutina 1
          </h3>
          <p className="text-slate-400 text-xs font-semibold uppercase tracking-wider">
            Lubricación, Filtros, Engrase, Líquidos, Tensión e Inspección
          </p>
        </div>
        <div className="px-4 py-2 bg-emerald-50 border border-emerald-100 text-emerald-800 text-[10px] font-black uppercase tracking-widest rounded-full shadow-sm animate-pulse">
          Formulario Oficial
        </div>
      </div>
      ...
      {formSuccess && (
        <div className="p-4 bg-emerald-500 border border-emerald-600 text-white rounded-2xl flex items-center gap-3 text-sm font-bold animate-bounce shadow-md">
          <CheckCircle2 size={22} className="text-white" /> ¡Rutina 1 registrada exitosamente!
        </div>
      )}
      {formError && (
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-8">
              ...
              {[
                ...
                <button
                  ...
                  className={`p-4 rounded-2xl border text-left transition-all flex items-center justify-between group ${
                    selectedCd === cdOpt.id
                      ? 'bg-emerald-50 border-emerald-500 text-emerald-950 shadow-sm ring-2 ring-emerald-500/10'
                ...
                >
                  ...
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                    selectedCd === cdOpt.id ? 'border-emerald-500 bg-emerald-500 text-white' : 'border-slate-300'
                  }`}>
          ...
          <div className="space-y-3 relative">
            ...
            <div className="relative max-w-md">
              <input
                ...
                placeholder="sGDGD"
                className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-mono font-black placeholder:text-slate-300 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white outline-none transition-all"
              />
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 bg-emerald-50/50 border border-emerald-100 rounded-2xl max-w-md flex items-center justify-between">
              <span className="text-xs font-black text-emerald-950 uppercase tracking-tight">Rutina 1</span>
            ...
            <div key={secNum} className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-6">
              ...
              <div className="border-b border-slate-100 pb-3">
                <h4 className="text-sm font-black text-slate-950 uppercase tracking-tight flex items-center gap-2">
                  <span className="w-6 h-6 rounded bg-emerald-100 text-emerald-700 font-black text-xs flex items-center justify-center">{secNum}</span>
                  {group.title}
                </h4>
              </div>
                    ...
                    <div key={item.id} className="p-4 md:p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white hover:bg-slate-50/40 transition-colors">
                      ...
                      <div className="space-y-1 max-w-xl">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[8px] bg-emerald-50 text-emerald-700 font-black uppercase tracking-wider px-2 py-0.5 rounded">
                            {item.category}
                          </span>
                        </div>
          ...
          <div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-4">
            ...
            <div className="space-y-4">
              ...
              {selectedPhotos.length > 0 ? (
                ...
                <label
                  htmlFor="routine-1-photo-input"
                  className="w-full h-48 bg-slate-50 hover:bg-emerald-50/5 border-2 border-dashed border-slate-200 hover:border-emerald-500/50 rounded-2xl flex flex-col items-center justify-center gap-2 text-slate-400 hover:text-emerald-700 cursor-pointer transition-all group"
                >
        ...
        <div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-2">
          ...
          <textarea
            ...
            className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl text-xs font-bold focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all resize-none"
          />
        </div>
