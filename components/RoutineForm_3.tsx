...
// 26 Specific checklist items for Routine 3
const CHECKLIST_ITEMS = [
  // ¿A los siguientes componentes se les realizó CAMBIO?
  { id: 'r3_c_aceite_motor', name: 'Aceite Motor', category: 'CAMBIO', sectionNum: 5, sectionTitle: '¿A los siguientes componentes se les realizó CAMBIO?' },
  { id: 'r3_c_filtro_aceite', name: 'Filtro de aceite', category: 'CAMBIO', sectionNum: 5, sectionTitle: '¿A los siguientes componentes se les realizó CAMBIO?' },
  { id: 'r3_c_filtro_primario', name: 'Filtro combustible primario', category: 'CAMBIO', sectionNum: 5, sectionTitle: '¿A los siguientes componentes se les realizó CAMBIO?' },
  { id: 'r3_c_filtro_secundario', name: 'Filtro combustible secundario o trampa de agua', category: 'CAMBIO', sectionNum: 5, sectionTitle: '¿A los siguientes componentes se les realizó CAMBIO?' },
  { id: 'r3_c_filtro_aire_secundario', name: 'Filtro de aire secundario', category: 'CAMBIO', sectionNum: 5, sectionTitle: '¿A los siguientes componentes se les realizó CAMBIO?' },

  // 5. ENGRASE
  { id: 'r3_e_suspension', name: 'General Suspensión', category: 'ENGRASE', sectionNum: 6, sectionTitle: '5. ¿A los siguientes componentes se les realizó ENGRASE?' },
  { id: 'r3_e_articulaciones', name: 'Articulaciones, Crucetas, Cardanes, Bujes y Pasadores', category: 'ENGRASE', sectionNum: 6, sectionTitle: '5. ¿A los siguientes componentes se les realizó ENGRASE?' },

  // 6. LIQUIDOS
  { id: 'r3_l_agua_bateria', name: 'Agua Batería', category: 'LIQUIDOS', sectionNum: 7, sectionTitle: '6. ¿A los siguientes componentes se les completó LIQUIDOS?' },
  { id: 'r3_l_refrigerante', name: 'Liquido Refrigerante y LimpiaParabrisas', category: 'LIQUIDOS', sectionNum: 7, sectionTitle: '6. ¿A los siguientes componentes se les completó LIQUIDOS?' },
  { id: 'r3_l_aceites_direccion', name: 'Aceites de dirección, Caja y Diferencial', category: 'LIQUIDOS', sectionNum: 7, sectionTitle: '6. ¿A los siguientes componentes se les completó LIQUIDOS?' },

  // 7. TENSION
  { id: 'r3_t_frenos', name: 'Frenos', category: 'TENSION', sectionNum: 8, sectionTitle: '7. ¿A los siguientes componentes se les realizó TENSIÓN?' },
  { id: 'r3_t_correas', name: 'Correas Motor', category: 'TENSION', sectionNum: 8, sectionTitle: '7. ¿A los siguientes componentes se les realizó TENSIÓN?' },
  { id: 'r3_t_embrague', name: 'Embrague y/o calibrar varillaje (según parámetros)', category: 'TENSION', sectionNum: 8, sectionTitle: '7. ¿A los siguientes componentes se les realizó TENSIÓN?' },

  // 8. INSPECCION
  { id: 'r3_i_filtro_aire', name: 'Filtro de aire primario y secundario', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_luces', name: 'Luces Delanteras, Traseras', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_luces_tablero', name: 'Luces e Indicadores de Tablero', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_mangueras_ref', name: 'Tuberías y Mangueras Refrigeración y la Concentración de refrigerante', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_mangueras_aceite', name: 'Tuberías y Mangueras Aceite', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_admision_escape', name: 'Sistema Admisión y Escape (Conductos y Turbo)', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_terminales_rotulas', name: 'Terminales y Rótulas', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_fugas', name: 'Fugas de aire y aceites', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_suspension', name: 'Suspensión en General', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_marcha_minima', name: 'Marcha Mínima motor', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_presion_llantas', name: 'Presión y labrado llantas', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },
  { id: 'r3_i_rotar_llantas', name: 'Rotar llantas (Si es necesario)', category: 'INSPECCION', sectionNum: 9, sectionTitle: '8. ¿A los siguientes componentes se les INSPECCIONÓ?' },

  // 9. LIMPIEZA
  { id: 'r3_p_trampa_agua', name: 'Trampa de agua (Sistema de combustible)', category: 'LIMPIEZA', sectionNum: 10, sectionTitle: '9. ¿Se realizó LIMPIEZA a los siguientes componentes?' }
];
...
export const getChecklistItemsByFrequency = (freq: string) => {
  ...
  if (freq === '5.000 km') {
    return CHECKLIST_ITEMS.filter(item => 
      item.id !== 'r3_p_trampa_agua'
    );
  }
  if (freq === '8.000 km') {
    return CHECKLIST_ITEMS.filter(item => 
      item.id !== 'r3_c_filtro_aire_secundario'
    );
  }
  if (freq === '10.000 km') {
    return CHECKLIST_ITEMS.filter(item => 
...
export const getItemDisplayName = (id: string, name: string, freq: string) => {
  if (id === 'r3_c_aceite_motor') {
    if (freq === '8.000 km') return 'Aceite Motor ( Para los Inter MV607 se realiza cada múltiplo de 16 mil KM)';
    if (freq === '10.000 km') return 'Aceite Motor (Para los NQR 2026 se realiza cada múltiplo de 20.000 KM)';
  }
  if (id === 'r3_c_filtro_aceite') {
    if (freq === '8.000 km') return 'Filtro de aceite ( Para los Inter MV607 se realiza cada múltiplo de 16 mil KM)';
    if (freq === '10.000 km') return 'Filtro de aceite (Para los NQR 2026 se realiza cada múltiplo de 20.000 KM)';
  }
  if (id === 'r3_c_filtro_primario') {
    if (freq === '8.000 km') return 'Filtro combustible primario ( Para los Inter MV607 se realiza cada 16 mil KM)';
  }
  return name;
};

export const RoutineForm_3: React.FC<RoutineForm3Props> = ({
  vehicles,
  drivers,
  onSuccess,
  onBack
  ...
  const handlePhotoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (updatedPhotos.length > 0) {
      const collage = await createMosaic(updatedPhotos, `EVIDENCIA RUTINA 3 - ${plate || 'N/A'}`);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!frequency) {
      setFormError('Debe elegir la frecuencia de mantenimiento preventivo de la rutina 3.');
      return;
    }
    ...
    // Build standard responses list
    const compiledResponses: RoutineResponse[] = CHECKLIST_ITEMS.map(item => {
      const isApplicable = getChecklistItemsByFrequency(frequency).some(i => i.id === item.id);
      const resp = responses[item.id] || { status: 'OK' };
      return {
        itemId: item.id,
        status: isApplicable ? resp.status : 'NA',
        noveltyDescription: isApplicable ? resp.note : undefined
      };
    });
    ...
    const newExecution: RoutineExecution = {
      ...
      templateId: 'rutina_3',
      templateName: 'RUTINA 3: Cambio de Filtros, Engrase, Líquidos y Suspensión',
  ...
  const currentItems = getChecklistItemsByFrequency(frequency);
  const sectionGroups = currentItems.reduce((acc, item) => {
    ...
    <div className="bg-slate-50 min-h-screen p-4 md:p-8 space-y-8 rounded-[2.5rem] border border-slate-200/60 shadow-inner">
      ...
      <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-in fade-in duration-200">
        <div className="space-y-1">
          ...
          <h3 className="text-2xl font-black text-slate-900 uppercase tracking-tight flex items-center gap-3">
            <ClipboardCheck className="text-purple-600" size={28} /> Llenado de Rutina 3
          </h3>
          <p className="text-slate-400 text-xs font-semibold uppercase tracking-wider">
            Cambio de Filtros, Engrase, Líquidos, Suspensión, Tensión e Inspección General de Llantas
          </p>
        </div>
        <div className="px-4 py-2 bg-purple-50 border border-purple-100 text-purple-800 text-[10px] font-black uppercase tracking-widest rounded-full shadow-sm animate-pulse">
          Formulario Oficial
        </div>
      </div>
      ...
      {formSuccess && (
        <div className="p-4 bg-emerald-500 border border-emerald-600 text-white rounded-2xl flex items-center gap-3 text-sm font-bold animate-bounce shadow-md">
          <CheckCircle2 size={22} className="text-white" /> ¡Rutina 3 registrada exitosamente!
        </div>
      )}
      {formError && (
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-8">
              ...
              {[
                ...
                <button
                  ...
                  className={`p-4 rounded-2xl border text-left transition-all flex items-center justify-between group ${
                    selectedCd === cdOpt.id
                      ? 'bg-purple-50 border-purple-500 text-purple-950 shadow-sm ring-2 ring-purple-500/10'
                ...
                >
                  ...
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                    selectedCd === cdOpt.id ? 'border-purple-500 bg-purple-500 text-white' : 'border-slate-300'
                  }`}>
          ...
          <div className="space-y-3 relative">
            ...
            <div className="relative max-w-md">
              <input
                ...
                placeholder="ABC123"
                className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-mono font-black placeholder:text-slate-300 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 focus:bg-white outline-none transition-all"
              />
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 bg-purple-50/50 border border-purple-100 rounded-2xl max-w-md flex items-center justify-between">
              <span className="text-xs font-black text-purple-950 uppercase tracking-tight">Rutina 3</span>
          ...
          {/* Question 4: Frecuencia de Mantenimiento Preventivo de Rutina 3 */}
          <div className="space-y-3">
            <label className="text-slate-900 font-black text-xs uppercase tracking-wider block">
              ¿Cuál es la frecuencia de mantenimiento preventivo de la rutina 3? <span className="text-rose-500">*</span>
            </label>
            ...
            <div key={secNum} className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-6">
              ...
              <div className="border-b border-slate-100 pb-3">
                <h4 className="text-sm font-black text-slate-950 uppercase tracking-tight flex items-center gap-2">
                  <span className="w-6 h-6 rounded bg-purple-100 text-purple-700 font-black text-xs flex items-center justify-center">{secNum === '5' ? 'C' : parseInt(secNum) - 1}</span>
                  {group.title}
                </h4>
              </div>
                    ...
                    <div key={item.id} className="p-4 md:p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white hover:bg-slate-50/40 transition-colors">
                      ...
                      <div className="space-y-1 max-w-xl">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[8px] bg-purple-50 text-purple-700 font-black uppercase tracking-wider px-2 py-0.5 rounded">
                            {item.category}
                          </span>
                        </div>
          ...
          <div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-4">
            ...
            <div className="space-y-4">
              ...
              {selectedPhotos.length > 0 ? (
                ...
                <label
                  htmlFor="routine-3-photo-input"
                  className="w-full h-48 bg-slate-50 hover:bg-purple-50/5 border-2 border-dashed border-slate-200 hover:border-purple-500/50 rounded-2xl flex flex-col items-center justify-center gap-2 text-slate-400 hover:text-purple-700 cursor-pointer transition-all group"
                >
                  <Camera size={24} className="text-slate-300 group-hover:text-purple-500 transition-all" />
        ...
        <div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-2">
          ...
          <textarea
            ...
            className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl text-xs font-bold focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none transition-all resize-none"
          />
        </div>
          ...
          <button
            ...
            className={`px-8 py-3 text-white text-xs font-black uppercase tracking-widest rounded-xl shadow-lg transition-all hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2 ${
              isSaving 
                ...
                : 'bg-purple-600 hover:bg-purple-700 hover:shadow-purple-600/25'
            }`}
          >
            {isSaving ? (
              <>
